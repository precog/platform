...
trait ShardSystemActorModule[Dataset] extends ProjectionsActorModule[Dataset] with YggConfigComponent {
  ...
  class ShardSystemActor[Dataset](storage: MetadataStorage) extends Actor with Logging {
